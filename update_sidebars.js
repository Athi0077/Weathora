...
const files = ['CurrentWeather.jsx', 'TripPlanner.jsx', 'MyTrips.jsx', 'OutdoorActivity.jsx', 'WorkPlanner.jsx', 'TripDetails.jsx'];
...
files.forEach(file => {
  ...
  // Add FileText, Settings to lucide-react if missing
  ...
  if (importMatch) {
    ...
    if (!imports.includes('Settings')) imports += ', Settings';
